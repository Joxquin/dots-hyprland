...
Singleton {
    ...
    FileView {
        ...
        path: Quickshell.shellPath("modules/common/plugins/bundled/discordVoice/manifest.json")
        onLoaded: root.scheduleRebuild()
    }
    FileView {
        ...
        path: Quickshell.shellPath("modules/common/plugins/bundled/nandoroid-media/manifest.json")
        onLoaded: root.scheduleRebuild()
    }
    FileView {
